      ...
      async callStructured<T>(call: ModelCall<T>): Promise<ModelResult<T>> {
        ...
        return {
          data: call.schema.parse({
            ...
            clearFields: [], suggestedSuburb: null, wantsMoreOptions: false, confirmed: false, offTopic: false, askedAbout: null, askedKind: null, pictureOf: null, mentionedOldFence: false, namedOffList: null,
          }),
