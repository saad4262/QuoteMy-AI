# 20 tiling, a plain floor priced by the square metre

Guards: the second trade end to end: its own questions in its own order, the tile-specific rate beating the general one, and a per-m2 total
    ...
    "quotes": [
      {
        ...
        "businessName": "Paky Tiles",
        "ratePerMeter": 72,
        "projectTotalMin": 1440,
        "projectTotalMax": 1440,
        "badges": [
          "incl. GST",
          "12.6 km away",
          "4.9★ (80)",
