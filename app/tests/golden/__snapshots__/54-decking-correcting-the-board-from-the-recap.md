# 54 decking, correcting the board from the recap

Guards: a correction re-asks one field and keeps the rest, on the field that headlines the quote - and the total has to move by the difference between two boards at the same height
...
```json
{
  ...
  "checklistDisplay": {
    ...
    "deckHeight": {
      "title": "Height",
      "value": "On the ground — step straight out"
    }
  },
  "checklistAnswered": [
    {
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, On the ground — step straight out, Composite, 20m², Standing on its own. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, On the ground — step straight out, Composite, 20m², Standing on its own. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, On the ground — step straight out, Merbau, 20m², Standing on its own. All correct?",
  "options": [
    {
      "label": "Yes, that's all correct",
      "value": "yes"
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, On the ground — step straight out, Merbau, 20m², Standing on its own. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
    ...
    "quotes": [
      {
        ...
        "businessName": "Berwick Decks",
        "ratePerMeter": 420,
        "projectTotalMin": 8550,
        "projectTotalMax": 8550,
        "badges": [
          "incl. GST",
          "In your suburb",
          "4.9★ (78)",
