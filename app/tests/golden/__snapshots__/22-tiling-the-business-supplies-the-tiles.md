# 22 tiling, the business supplies the tiles

Guards: supply_and_install adds the business own published tile price per m2 - never a figure from a web search
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Floor only, Porcelain, 20m², They supply the tiles. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Floor only, Porcelain, 20m², They supply the tiles. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
  ...
  "results": [
    {
      ...
      "ratePerMeter": 117,
      "estimatedTotal": 2340,
      "notes": "incl. GST · 12.6 km away · 4.9★ (80) · Tiles supplied"
    }
  ],
  "avgRatePerMeter": 117,
  "unit": "m2",
    ...
    "quotes": [
      {
        ...
        "businessName": "Paky Tiles",
        "ratePerMeter": 117,
        "projectTotalMin": 2340,
        "projectTotalMax": 2340,
        "badges": [
          "incl. GST",
          "12.6 km away",
          "4.9★ (80)",
