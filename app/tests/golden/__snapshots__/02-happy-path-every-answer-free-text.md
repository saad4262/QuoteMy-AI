# 02 happy path, every answer free text

Guards: the model path, oneOf/heightKeyFrom/conditionsFrom resolution, and mentioned()
...
customer: "a single pedestrian gate"
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Aluminium, 1.8m, 30m, removing the old timber fence, 2 x single pedestrian gate. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Aluminium, 1.8m, 30m, removing the old timber fence, 2 x single pedestrian gate. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
  ...
  "results": [
    {
      "businessId": "biz-2",
      "autoAcceptsAi": true,
      "businessName": "Aluminium Specialists",
      "suburb": "Berwick, VIC 3806",
      "ratePerMeter": 155,
      "estimatedTotal": 5850,
      "notes": "incl. GST · In your suburb · 4.8★ (120) · Removal included · 2 gates included"
    }
  ],
  "avgRatePerMeter": 155,
  "comparison": {
    ...
    "quotes": [
      {
        ...
        "businessName": "Aluminium Specialists",
        "ratePerMeter": 155,
        "projectTotalMin": 5850,
        "projectTotalMax": 5850,
        "badges": [
          "incl. GST",
          "In your suburb",
          "4.8★ (120)",
