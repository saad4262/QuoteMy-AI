# 06 correcting with something that resolves to nothing, then a typo that does

Guards: fixingUnresolved, and the FIELD_ALIASES typo tolerance that fixed "lenght"
...
```json
{
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Sorry, I didn't catch which one — which of these should I change?",
      "lastValues": [
        "suburb",
        "material",
        "heightKey",
      ...
      "history": [
        ...
        {
          "you": "the blue one",
          "me": "Sorry, I didn't catch which one — which of these should I change?"
        }
      ],
      "trade": "fencing"
    }
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Colorbond, 1.8m, 30m. All correct?",
  "options": [
    {
      "label": "Yes, that's all correct",
      "value": "yes"
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Colorbond, 1.8m, 30m. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
      ...
      "history": [
        ...
        {
          "you": "30",
          "me": "Got it — Berwick, VIC 3806, Colorbond, 1.8m, 30m. All correct?"
        }
      ],
      "trade": "fencing"
    }
    ...
    "quotes": [
      {
        ...
        "businessName": "Southeast Fencing & Gates",
        "ratePerMeter": 110,
        "projectTotalMin": 3300,
        "projectTotalMax": 3300,
        "badges": [
          "incl. GST",
          "In your suburb",
          "4.8★ (120)"
