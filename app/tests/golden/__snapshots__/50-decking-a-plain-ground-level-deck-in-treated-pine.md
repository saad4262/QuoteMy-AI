# 50 decking, a plain ground-level deck in treated pine

Guards: the fifth trade end to end: height asked FIRST because it decides the build, then the board, and a per-square-metre total with nothing added
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, On the ground — step straight out, Treated pine, 24m², Standing on its own. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, On the ground — step straight out, Treated pine, 24m², Standing on its own. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
    ...
    "quotes": [
      {
        ...
        "businessName": "Berwick Decks",
        "ratePerMeter": 280,
        "projectTotalMin": 6870,
        "projectTotalMax": 6870,
        "badges": [
          "incl. GST",
          "In your suburb",
          "4.9★ (78)",
