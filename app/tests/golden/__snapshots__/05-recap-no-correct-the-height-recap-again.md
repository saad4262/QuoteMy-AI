# 05 recap, no, correct the height, recap again

Guards: saidNo, fixing mode, and clearFields emptying exactly one field
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Colorbond, 1.2m, 20m. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Colorbond, 1.2m, 20m. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
