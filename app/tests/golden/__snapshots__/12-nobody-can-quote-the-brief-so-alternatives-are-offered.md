# 12 nobody can quote the brief, so alternatives are offered

Guards: the alternatives fallback and the alt: prefix resolving two fields at once
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Aluminium, 1.8m, 20m. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Aluminium, 1.8m, 20m. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
...
```json
{
  ...
  "type": "question",
  "message": "Nobody near you does Aluminium at 1.8m. The closest they can do is Colorbond at 1.8m, $2,200 from Only Does Colorbond. Want one of these instead?",
  "options": [
    {
      "label": "Colorbond, 1.8m · $2,200",
