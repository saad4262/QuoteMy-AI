# 13 a height nobody builds at

Guards: an off-list measure is refused rather than silently rounded to the nearest one
...
```json
{
  ...
  "type": "question",
  "message": "Fences are not built at 1.65m — which of these is closest?",
  "options": [
    {
      "label": "1.2m",
      "value": "1.2m"
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": "heightKey",
      "lastQuestion": "Fences are not built at 1.65m — which of these is closest?",
      "lastValues": [
        "1.2m",
        "1.5m",
        "1.8m",
      ...
      "history": [
        ...
        {
          "you": "1.65m",
          "me": "Fences are not built at 1.65m — which of these is closest?"
        }
      ],
      "trade": "fencing"
    }
