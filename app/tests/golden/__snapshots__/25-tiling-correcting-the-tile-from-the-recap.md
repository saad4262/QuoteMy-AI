# 25 tiling, correcting the tile from the recap

Guards: saying which field is wrong reopens THAT field - the words belong to the field, not to a table keyed on fencing names
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "history": [
        ...
        {
          "you": "the tile's wrong",
          "me": "What tile are you using?"
        }
      ],
      "trade": "tiling"
    }
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Floor only, Ceramic, 20m², I'm buying the tiles. All correct?",
  "options": [
    {
      "label": "Yes, that's all correct",
      "value": "yes"
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Floor only, Ceramic, 20m², I'm buying the tiles. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
    ...
    "quotes": [
      {
        ...
        "businessName": "Paky Tiles",
        "ratePerMeter": 65,
        "projectTotalMin": 1300,
        "projectTotalMax": 1300,
        "badges": [
          "incl. GST",
          "12.6 km away",
          "4.9★ (80)",
