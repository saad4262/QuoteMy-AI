# 43 retaining wall, a builder who does band their rates by height

Guards: the nullable third key: a row written for this exact height beats the general one, and a height past every band they published falls back to the DEAREST rather than the nearest - nobody may be shown a total below what they will be charged
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Concrete sleepers, They supply the materials, 20m, 1.2m. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Concrete sleepers, They supply the materials, 20m, 1.2m. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
  ...
  "results": [
    {
      ...
      "ratePerMeter": 465,
      "estimatedTotal": 9450,
      "notes": "incl. GST · In your suburb · 4.8★ (52) · Materials supplied · Rate for 1.2m · Includes $150 site inspection"
    }
  ],
  "avgRatePerMeter": 465,
  "unit": "m",
    ...
    "quotes": [
      {
        ...
        "businessName": "Berwick Retaining Wall",
        "ratePerMeter": 465,
        "projectTotalMin": 9450,
        "projectTotalMax": 9450,
        "badges": [
          "incl. GST",
          "In your suburb",
          "4.8★ (52)",
