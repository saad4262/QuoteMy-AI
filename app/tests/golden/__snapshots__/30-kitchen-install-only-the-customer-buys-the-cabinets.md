# 30 kitchen, install only, the customer buys the cabinets

Guards: the third trade end to end: no quantity question at all, size as the rate key, and a total built from one job price plus fixed items
...
```json
{
  ...
  "type": "confirmation",
  "message": "Got it — Berwick, VIC 3806, Fitting one I've bought, Standard — an L-shape, I'm supplying the cabinets. All correct?",
  "options": [
    {
  ...
  "checklist": {
    ...
    "_ui": {
      ...
      "lastAsked": null,
      "lastQuestion": "Got it — Berwick, VIC 3806, Fitting one I've bought, Standard — an L-shape, I'm supplying the cabinets. All correct?",
      "lastValues": [
        "yes",
        "no"
      ],
  ...
  "results": [
    {
      ...
      "ratePerMeter": 2970,
      "estimatedTotal": 2970,
      "notes": "incl. GST · 12.6 km away · 4.7★ (64) · You supply the cabinets · Includes $120 site measure"
    }
  ],
  "avgRatePerMeter": 2970,
  "unit": "item",
  "comparison": {
    ...
    "quotes": [
      {
        ...
        "businessName": "Beky Kitchens",
        "ratePerMeter": 2970,
        "projectTotalMin": 2970,
        "projectTotalMax": 2970,
        "badges": [
          "incl. GST",
          "12.6 km away",
          "4.7★ (64)",
